namespace NQuotes 
{
    public class MqlApiWithStdLib : NQuotes.MqlApi
    {
        ...
        //+------------------------------------------------------------------+
        public bool CompareDoubles(double number1, double number2)
        {
        ...
        double[] DecimalArray = new double[] { 1.0, 10.0, 100.0,1000.0, 10000.0, 100000.0, 1000000.0, 10000000.0, 100000000.0, 1000000000.0, 10000000000.0, 100000000000.0, 1000000000000.0, 10000000000000.0, 100000000000000.0, 1000000000000000.0, 10000000000000000.0};
        public string DoubleToStrMorePrecision(double number, int precision)
        {
        ...
        //+------------------------------------------------------------------+
        public string IntegerToHexString(int integer_number)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                if (value < 10)
                    hex_string = StringSetChar(hex_string, i, (char)(value + '0'));
                else
                    hex_string = StringSetChar(hex_string, i, (char)((value - 10) + 'A'));
                shift -= 4;
            }
            //---
            return (hex_string);
